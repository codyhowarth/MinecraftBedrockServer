...
if [ -d "$ServerName" ]; then
  ...
  wget -O start.sh https://github.com/codyhowarth/MinecraftBedrockServer/master/start.sh
  chmod +x start.sh
  ...
  wget -O stop.sh https://github.com/codyhowarth/MinecraftBedrockServer/master/stop.sh
  chmod +x stop.sh
  ...
  wget -O restart.sh https://github.com/codyhowarth/MinecraftBedrockServer/master/restart.sh
  chmod +x restart.sh
  ...
  sudo wget -O /etc/systemd/system/$ServerName.service https://github.com/codyhowarth/MinecraftBedrockServer/master/minecraftbe.service
...
if [[ "$CPUArch" == *"aarch"* || "$CPUArch" == *"arm"* ]]; then
  ...
  wget -O depends.zip https://github.com/codyhowarth/MinecraftBedrockServer/master/depends.zip
  unzip depends.zip
  sudo mkdir /lib64
